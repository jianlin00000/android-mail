...
public class MailInfo {
    ...
    public String toString() {
        return "MailInfo{" + "mailServerHost='" + mailServerHost + '\'' + ", mailServerPort='" + mailServerPort + '\'' + ", fromAddress='" + fromAddress + '\'' + ", toAddress='" + toAddress + '\'' + ", userName='" + userName + '\'' + ", password='" + password + '\'' + ", validate=" + validate + ", subject='" + subject + '\'' + ", content='" + content + '\'' + ", attachFileNames=" + Arrays
                .toString(attachFileNames) + '}';
    }
}
